...
@Component({
  selector: 'app-attestation-fiscale',
  templateUrl: './attestation-fiscale.component.html',
  styleUrls: ['./attestation-fiscale.component.css']
})
export class AttestationFiscaleComponent {
  ...
  constructor(private formBuilder:FormBuilder,
    ...
    attestation(client:any){
      ...
      urlString  = baseUrl + "/html2pdf/rapports/attestation.php?id_client="+client.id_client+"&du="+this.date_attestation;
